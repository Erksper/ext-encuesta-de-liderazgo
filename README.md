...
```
(npm run sync; cd site; vendor/bin/phpunit tests/unit/Espo/Modules/EncuestaDeLiderazgo)
```
...
```
(npm run sync; cd site; vendor/bin/phpunit tests/integration/Espo/Modules/EncuestaDeLiderazgo)
```
...
If your extension contains additional PHP packages, you also need to add `site/custom/Espo/Modules/EncuestaDeLiderazgo/vendor` to the *scanDirectories* section in *phpstan.neon* config.
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/EncuestaDeLiderazgo`
* `site/tests/integration/Espo/Modules/EncuestaDeLiderazgo`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/EncuestaDeLiderazgo/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/EncuestaDeLiderazgo/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/encuesta-de-liderazgo/lib/init.js"
        ]
    }
    ```
...
Add the library module path to `src/files/custom/Espo/Modules/EncuestaDeLiderazgo/Resources/metadata/app/jsLibs.json`

```json
{
    "some-lib": {
        "path": "client/custom/modules/encuesta-de-liderazgo/lib/some-lib.js"
    }
}
```
